...
export class WorldbuildingComponent implements OnInit {
  ...
  navInfo: any[] = [
    { link: 'introduction', name: 'Introduction', src: 'https://firebasestorage.googleapis.com/v0/b/arecaceworld.appspot.com/o/WebSite%2Fworld%20buttons%2Fintro%202.png?alt=media&token=32c3f3d8-063d-4923-8f39-dc7890deb8e1' },
