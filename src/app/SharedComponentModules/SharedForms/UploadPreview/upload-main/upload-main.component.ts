...
export class UploadMainComponent implements OnInit, OnDestroy {
  ...
  @Input() Settings: UploadPreviewSettings = new UploadPreviewSettings([
  ...
  autoGenHelp = 'Transparency is maintained; however, autogenerated thumbs for animated gifs will only show the first frame!';
  oldThumb: string;
  oldMain: string;
  ...
  constructor(
    private previewserv: UploadPreviewService,
