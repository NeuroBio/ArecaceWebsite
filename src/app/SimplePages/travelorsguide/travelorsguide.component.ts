...
export class TravelorsGuideComponent implements OnInit {
  ...
  previews = ["https://firebasestorage.googleapis.com/v0/b/arecaceworld.appspot.com/o/WebSite%2FTraveler'sGuide%2Fpage1.png?alt=media&token=8afd8eed-2d6c-4827-b857-d6e11d9aecfc",
